...
| 2026-03-29 | `ios-v0.6.0`                                            | Self Driving Scaffold & Map Persistence               | Redesigned app flow and established the unified 10Hz control loop coordinating ARKit, ESC telemetry, and STM32 actuation.    | `metalbot-ios/CHANGELOG.md` `0.6.0`; `metalbot-ios/Sources/Views/SelfDrivingView.swift`                                          |
| 2026-03-29 | `ios-v0.7.0`                                            | Planner Framework & Safety Supervisor                 | Scaffolded the planner protocol/orchestrator, added WaypointPlanner, and integrated TTC-based LiDAR safety supervisor.       | `metalbot-ios/CHANGELOG.md` `0.7.0`; `metalbot-ios/Sources/Planner/`                                                             |
| 2026-03-31 | `ios-v0.8.0`                                            | End-to-End Self-Driving & Safety                      | Implemented autonomous driving stack with tri-zone state machine, eliminated stop-go oscillation, and added full test suite. | `metalbot-ios/CHANGELOG.md` `0.8.0`; `metalbot-ios/Tests/Planner/`                                                               |
