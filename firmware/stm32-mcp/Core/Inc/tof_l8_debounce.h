...
/*
 * tof_l8_debounce — debounce predicate for VL53L8CX reconfiguration.
 *
 * The VL53L8CX I²C state machine can be corrupted by rapid stop/start cycles,
 ...
 *
 * Sentinel: a last_configure_tick of 0 means "no prior configure". TofL8_Init
...
#ifndef TOF_L8_DEBOUNCE_H
#define TOF_L8_DEBOUNCE_H
...
#define TOF_L8_RECONFIGURE_DEBOUNCE_MS 500u
 ...
 */
bool TofL8Debounce_ShouldSkip(uint32_t now_ms,
