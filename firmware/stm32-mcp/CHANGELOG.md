...
- **SATEL-VL53L8 mechanical integration plan**: Added harness recommendations, source image references, full-SATEL and snap-off mini-PCB deployment visuals, car installation/assembly diagrams, and parametric OpenSCAD enclosures with board retention, harness strain relief, mount previews, and FOV keepout previews.
