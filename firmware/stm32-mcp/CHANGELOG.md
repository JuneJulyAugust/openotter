...
- **SATEL-VL53L8 mechanical integration plan**: Added harness recommendations, snap-off mini-PCB electrical cautions, and a parametric OpenSCAD enclosure for front/rear ToF deployment.
