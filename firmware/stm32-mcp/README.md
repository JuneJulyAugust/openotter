...
- `BLE/`: BlueNRG-MS middleware (transport layer, GATT, GAP, timer server, SPI HW). Not tracked; populate with `scripts/fetch-deps.sh`.
- `Drivers/`: STM32 HAL, CMSIS, and VL53L8CX vendor libraries. Not tracked; populate with `scripts/fetch-deps.sh`.
